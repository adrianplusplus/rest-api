...
def setup_logger(location, app):
    """Set up the global logging settings."""
    generated_files = location
    ALL_LOG_FILENAME = '{0}/smqdash-all.log'.format(generated_files)
    ERROR_LOG_FILENAME = '{0}/smqdash-error.log'.format(generated_files)
